		...
		<!-- One -->
			<section id="one" class="main special">
				<div class="container">
					...
					<form method="post" action="new_member_act.php" >
						<div class="row uniform">
							<div class="6u 12u$(xsmall)">
								<select class="form-control" name="grade" >
									<option value="33">33期</option>
									<option value="34">34期</option>
									<option value="35">35期</option>
									<option value="36">36期</option>
							        <option value="37">37期</option>
							        <option value="38">38期</option>
							        <option value="39">39期</option>
							...
							<div><input type="text" name="name" id="name" placeholder="姓名" /></div>
							<div class="12u$">
								<ul class="actions">
									<li><input type="button" value="登録" class="special" onclick="return chk3(this.form)" /></li>
								</ul>

								<script type="text/javascript">
								    function chk3(frm){
								        if(frm.elements["name"].value===""){
								            sweetAlert("名前を入力してください","", "error");
...
<input type="button"  value="会計専用ページに戻る" onclick="location.href='login_act.php'">

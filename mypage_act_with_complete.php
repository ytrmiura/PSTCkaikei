...
try{
		...
		$stmt = $pdo->prepare("SELECT * FROM tainou WHERE id = ?");
...
<script type="text/javascript">
	...
	function(inputValue){
		...
		if (inputValue !="kaikei") {
		swal("パスワードが違います", '', "error");
			return false;
		}else if(inputValue==="kaikei"){
		//location.reload();
		frm.submit();
		}

				...
				<div class="container">
					...
					<div class="content">
						...
						<form action="mypage_act.php" method="post">
						    ...
						    <label class="col-sm-2 control-label">あなたは何期？？</label>
						    <div class="col-sm-10">
						    ...
						    <div class="form-group">
    						<label class="col-sm-2 control-label">あなたの名前は？</label>
    						<div class="col-sm-10">
						...
						<button type="submit" class="btn scpecial scrolly">送信</button>
						</form>
					</ul>
					</div>

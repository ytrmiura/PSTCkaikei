					...
					<div class="content">
						...
						<h2>会計専用ページ</h2>
									...
									<ul class="actions vertical">
										<li><a href="new_member.php" class="button fit">メンバー追加</a></li>
										<li><a href="new_event.php" class="button fit">イベント追加</a></li>
										<li><a href="update.php" class="button fit">滞納費更新</a></li>
									</ul>
